...
import { useTheme } from "src/themes/themeContext"; // adjust if your path differs
import { createAddressAutocompleteStyles } from "./AddressAutocomplete.css";
import { useAddressAutocomplete } from "./useAddressAutocomplete.hook";
...
const AddressAutocomplete = ({
  ...
  const styles = useMemo(
    () => createAddressAutocompleteStyles({ theme, isFocused }),
    [theme, isFocused]
  );
