...
const AddressAutocomplete = () => {
  ...
  useEffect(() => {
    if (!window.google) {
      if (!googleMapsApiKey) {
        console.warn(
          "Google Maps API key is missing; map features may not load."
        );
      }
  ...
  const initMap = () => {
    if (mapRef.current && window.google) {
      ...
      const defaultLocation = { lat: 39.76833, lng: -86.1581 };
  ...
  const styles = {
    container: {
      ...
      padding: "2rem",
      backgroundColor:
        theme === "dark" ? "rgba(0, 0, 0, 1)ff" : "rgba(255, 255, 255, 1)",
    },
    title: {
      fontSize: "1.5rem",
      fontWeight: 600,
    ...
    suggestionHover: {
      backgroundColor: theme === "dark" ? "rgba(0, 0, 0, 1)ff" : "#f7fafc",
    },
    suggestionIcon: {
      marginTop: "0.25rem",
      flexShrink: 0,
    ...
    suggestionText: {
      fontSize: "0.9375rem",
      color: theme === "dark" ? "rgba(75, 75, 75, 1)" : "#2d3748",
      flex: 1,
    },
    mapContainer: {
      width: "100%",
    ...
    loadingText: {
      padding: "1rem",
      textAlign: "center",
      color: theme === "dark" ? "rgba(255, 255, 255, 1)" : "#718096",
      fontSize: "0.875rem",
    },
    instructions: {
      fontSize: "0.875rem",
